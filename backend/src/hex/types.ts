import type { SessionSummary } from '../lobby/types.js';
...
export type PublicHexSessionState = {
  sessionId: string;
  tableId: string;
  gameType: 'hex';
  players: HexPlayer[];
...
export type HexMoveInput = {
  row: number;
  col: number;
};

export type HexSessionCreatedFromLobby = SessionSummary & { gameType: 'hex' };
